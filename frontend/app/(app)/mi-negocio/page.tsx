...
export default function MiNegocioPage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-neutral-100">
      ...
      {/* Panel inferior */}
      <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-3xl border-t border-neutral-200 px-4 pt-4 pb-6 shadow-[0_-4px_20px_rgba(0,0,0,0.08)]">
        ...
        <input
          ...
          className="w-full bg-neutral-100 rounded-xl px-4 py-3 text-sm mb-3 outline-none focus:ring-2 focus:ring-green-500"
        />
        ...
        <div className="flex gap-3 mb-4">
          <input
            ...
            className="flex-1 bg-neutral-100 rounded-xl px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-green-500"
          />

          {type === "SERVICE" && (
            <div className="w-32 flex items-center bg-neutral-100 rounded-xl px-4 py-3 text-sm">
              <input
                type="number"
                value={duration}
