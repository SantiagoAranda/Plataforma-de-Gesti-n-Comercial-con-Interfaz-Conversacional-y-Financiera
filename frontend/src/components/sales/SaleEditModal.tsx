      ...
      <div className="w-full sm:max-w-md flex flex-col bg-white rounded-t-2xl sm:rounded-2xl shadow-xl overflow-hidden h-[90vh] sm:h-auto sm:max-h-[85vh] relative animate-in slide-in-from-bottom-full duration-300">
        <div className="px-5 py-4 border-b border-neutral-100 flex items-center justify-between bg-white sticky top-0 z-20">
          <div className="flex flex-col">
            <h2 className="font-medium text-neutral-900 text-lg">Editar Pedido</h2>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-6 bg-neutral-50/20">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-2 mt-2">
              ...
              <div className="col-span-2 pt-2 border-t border-neutral-50">
                <div className="flex items-center justify-between">
                  <span className="text-[9px] font-medium text-neutral-400 uppercase tracking-widest">Origen de la venta</span>
                  <span className="text-[11px] font-medium text-neutral-700 bg-neutral-100 px-2 py-0.5 rounded-md">
            ...
            <div className="col-span-2 flex flex-col gap-1 pt-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className={`rounded-lg px-3 py-2 text-xs font-medium transition ${paymentMethod === "CASH"
                ...
                <button
                  ...
                  className={`rounded-lg px-3 py-2 text-xs font-medium transition ${paymentMethod === "BANK_TRANSFER"
                    ? "bg-emerald-500 text-white"
                    : "border border-neutral-200 bg-neutral-50 text-neutral-700"
                    }`}
                >
          ...
          {type === "SERVICIO" && (
            <div className="rounded-xl border border-neutral-100 bg-white p-4 space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-[10px] font-medium text-neutral-400 uppercase tracking-widest">Turno</div>
            ...
            <div className="space-y-2">
              ...
              {items.length === 0 && (
                <div className="text-center py-10 border-2 border-dashed border-neutral-100 rounded-2xl">
                  <p className="text-[11px] font-medium text-neutral-300 uppercase italic">Sin productos en la lista</p>
                </div>
              )}
            </div>
          </div>
