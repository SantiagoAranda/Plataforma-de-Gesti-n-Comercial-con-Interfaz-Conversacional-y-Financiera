...
import { getRecipe, listIngredients, replaceRecipe, type RecipeLine } from "@/src/services/inventory";
...
export function RecipeEditor({ selectedItemId, onSelectItemId }: Props) {
        ...
        <div className="rounded-3xl bg-white p-4 shadow-sm ring-1 ring-black/5">
          ...
          {loadingRecipe ? (
            ...
            <div className="mt-4 space-y-3">
              ...
              {!lines.length && (
                <div className="rounded-2xl border border-dashed border-neutral-200 bg-white px-6 py-10 text-center text-neutral-400">
                  Sin receta. Agrega una l&iacute;nea para comenzar.
                </div>
              )}
            </div>
          )}
