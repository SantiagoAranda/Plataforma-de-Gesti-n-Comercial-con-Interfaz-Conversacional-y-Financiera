        ...
        <div className="flex flex-col gap-3 md:grid md:grid-cols-[minmax(0,1fr)_220px] md:items-start">
          ...
          <label className="flex min-w-0 flex-col gap-1">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-neutral-200 bg-neutral-50 px-3 py-3 text-sm focus:border-emerald-400 focus:outline-none disabled:cursor-not-allowed disabled:opacity-60"
            />
          </label>
        </div>
